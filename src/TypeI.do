...
add wave -noupdate -radix decimal /RISC_V_Single_Cycle_TB/DUV/PROGRAM_MEMORY/Rs
add wave -noupdate -radix decimal /RISC_V_Single_Cycle_TB/DUV/PROGRAM_MEMORY/Imm
